...
!* HP Palmtop code for talking to the Hornet Chip
!*
_cmd:	
	pushf
	push	ax
...
!*	callf	0xa12d, 0xf000
	call	_hp_clock
	mov	bx, _hp_boot_secs
	mov	ax, _hp_boot_secs+2
	sub	bx, dx
	sbb	ax, cx
	mov	_hp_dif_secs, bx
	mov	_hp_dif_secs+2, ax
	pop	dx
	pop	cx
	pop	bx
	pop	ax
...
_get_hp_clock:
	call	_hp_clock
	mov	_hp_boot_secs, dx
	mov	_hp_boot_secs+2, cx
	ret
